...
export default define.page(function Home() {
    return (
        <>
            <Head>
                <title>Lang Master - 日语学习大师</title>
                <meta
                    name="description"
                    ...
                    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                        <div class="flex justify-between items-center h-16">
                            ...
                            <div class="flex items-center gap-6">
                                ...
                                <a
                                    href="/quiz"
                                    class="px-4 sm:px-6 py-2 bg-gradient-to-r from-purple-600 to-pink-600 text-white font-semibold rounded-full hover:shadow-lg hover:scale-105 transition-all text-sm sm:text-base"
                                >
                                    开始测验
                                </a>
                            </div>
                    ...
                    <div class="max-w-7xl mx-auto">
                        <div class="text-center">
                            ...
                            <div class="flex flex-col sm:flex-row gap-4 justify-center items-center">
                                <a
                                    href="/quiz"
                                    class="px-6 sm:px-8 py-3 sm:py-4 bg-gradient-to-r from-purple-600 to-pink-600 text-white text-base sm:text-lg font-bold rounded-full shadow-xl hover:shadow-2xl hover:scale-105 transition-all"
                                >
                                    🚀 立即开始学习
                                </a>
                                <a
                ...
                <footer class="py-12 px-4 bg-gray-900 text-white">
                    <div class="max-w-7xl mx-auto text-center">
                        <div class="flex items-center justify-center gap-3 mb-4">
                            ...
                            <span class="text-2xl font-bold">Lang Master</span>
                        </div>
                        ...
                        <p class="text-gray-500 text-sm">
                            © 2024 Lang Master. 使用 Fresh & Preact Signals
                            构建。
                        </p>
                    </div>
                </footer>
